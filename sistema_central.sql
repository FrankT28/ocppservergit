...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-05-2022 a las 05:33:46
...
INSERT INTO `estaciones` (`id_estacion`, `codigoEstacion`, `nombreEstacion`, `cantidadConectores`, `fotoEstacion`, `potenciaMinima`, `potenciaMaxima`, `voltajeMinimo`, `voltajeMaximo`, `corrienteMinima`, `corrienteMaxima`, `fases`, `cargasSimultaneas`) VALUES
(1, 'EC_CENTRO_SUR_1', 'Estación de carga rápida Centro Sur 1', 3, 'si', '10', '50', '127', '220', '1', '60', 3, 'si');
...
--
ALTER TABLE `tarjetas`
  MODIFY `id_tarjeta` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de la tabla `transacciones`
--
ALTER TABLE `transacciones`
  MODIFY `id_transaccion` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
