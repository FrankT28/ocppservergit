...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-07-2022 a las 18:38:03
...
(9, '0701069288', 'victor', 'Pasaje', 'Loma de Franco', '0999999999', 'victor@gmail.com', 2, '2022-06-24', '14:19:46');
...
--
-- Estructura de tabla para la tabla `current_import_phase1`
--

CREATE TABLE `current_import_phase1` (
  `id_current_import_phase1` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `current_import_phase2`
--

CREATE TABLE `current_import_phase2` (
  `id_current_import_phase2` int(11) NOT NULL,
  `id_transaccion` int(11) NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `valor` float(10,2) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
--
-- Estructura de tabla para la tabla `current_import_phase3`
--

CREATE TABLE `current_import_phase3` (
  `id_current_import_phase3` int(11) NOT NULL,
  `id_transaccion` int(11) NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `valor` float(10,2) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
--
-- Estructura de tabla para la tabla `current_offered`
--

CREATE TABLE `current_offered` (
  `id_current_offered` int(11) NOT NULL,
  `id_transaccion` int(11) NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `valor` float(10,2) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
--
-- Estructura de tabla para la tabla `energia_transacciones`
--

CREATE TABLE `energia_transacciones` (
  `id_ener_trans` int(11) NOT NULL,
  `id_transaccion` int(11) NOT NULL,
  `id_estacion` int(11) NOT NULL,
  `id_conector` int(11) NOT NULL,
  `fecha` date NOT NULL,
...
--
-- Estructura de tabla para la tabla `energy_active_import_register`
--

CREATE TABLE `energy_active_import_register` (
  `id_ene_act_imp_reg` int(11) NOT NULL,
  `id_transaccion` int(11) NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `valor` float(10,2) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
(1, 'EC0120040002R', 'Estación de carga rápida Centro Sur 1', 'Ave Max Uhle y Pumapungo, Cuenca', 3, 'si', '10', '50', '127', '220', '1', '60', 3, 'si');
...
(4, 'Reservaciones', 'reservaciones', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `ping_estacion`
--

CREATE TABLE `ping_estacion` (
  `id_ping_estacion` int(11) NOT NULL,
  `id_estacion` int(11) NOT NULL,
  `fecha` date NOT NULL,
  `hora` time NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
--
-- Volcado de datos para la tabla `ping_estacion`
--

INSERT INTO `ping_estacion` (`id_ping_estacion`, `id_estacion`, `fecha`, `hora`) VALUES
(1, 1, '2022-06-26', '22:56:03');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `potencia_transacciones`
--

CREATE TABLE `potencia_transacciones` (
  `id_pot_trans` int(11) NOT NULL,
  `id_transaccion` int(11) NOT NULL,
  `id_estacion` int(11) NOT NULL,
  `id_conector` int(11) NOT NULL,
  `fecha` date NOT NULL,
...
--
-- Volcado de datos para la tabla `potencia_transacciones`
--

INSERT INTO `potencia_transacciones` (`id_pot_trans`, `id_transaccion`, `id_estacion`, `id_conector`, `fecha`, `hora`, `valor`) VALUES
(1, 594, 1, 1, '0000-00-00', '2022-07-02 00:48:39', 4.00);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `power_active_import`
--

CREATE TABLE `power_active_import` (
  `id_pow_act_imp` int(11) NOT NULL,
  `id_transaccion` int(11) NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `valor` float(10,2) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
--
-- Estructura de tabla para la tabla `state_of_charge`
--

CREATE TABLE `state_of_charge` (
  `id_state_of_charge` int(11) NOT NULL,
  `id_transaccion` int(11) NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `valor` float(10,2) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `transacciones` (
  ...
  `energiaConsumida` decimal(10,2) NOT NULL,
  `estado` varchar(20) NOT NULL,
...
(36, 1, 1, 1, '2022-06-26', '19:23:43', '19:23:57', '4.00', '5.00', '1.00', 'Finalizada', 'Local'),
(37, 1, 1, 1, '2022-06-26', '21:33:37', '21:33:37', '4.00', '4.00', '0.00', 'Iniciada', 'Iniciada'),
(38, 1, 1, 1, '2022-06-26', '21:34:14', '21:34:14', '4.00', '4.00', '0.00', 'Iniciada', 'Iniciada'),
(39, 1, 1, 1, '2022-06-26', '21:34:52', '21:35:02', '4.00', '5.00', '1.00', 'Finalizada', 'Local');
...
--
-- Estructura de tabla para la tabla `voltage_phase1n`
--

CREATE TABLE `voltage_phase1n` (
  `id_voltage_phase1n` int(11) NOT NULL,
  `id_transaccion` int(11) NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `valor` float(10,2) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
--
-- Estructura de tabla para la tabla `voltage_phase2n`
--

CREATE TABLE `voltage_phase2n` (
  `id_voltage_phase2n` int(11) NOT NULL,
  `id_transaccion` int(11) NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `valor` float(10,2) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
--
-- Estructura de tabla para la tabla `voltage_phase3n`
--

CREATE TABLE `voltage_phase3n` (
  `id_voltage_phase3n` int(11) NOT NULL,
  `id_transaccion` int(11) NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `valor` float(10,2) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
--
-- Indices de la tabla `current_import_phase1`
--
ALTER TABLE `current_import_phase1`
  ADD PRIMARY KEY (`id_current_import_phase1`);

--
-- Indices de la tabla `current_import_phase2`
--
ALTER TABLE `current_import_phase2`
  ADD PRIMARY KEY (`id_current_import_phase2`);

--
-- Indices de la tabla `current_import_phase3`
--
ALTER TABLE `current_import_phase3`
  ADD PRIMARY KEY (`id_current_import_phase3`);

--
-- Indices de la tabla `current_offered`
--
ALTER TABLE `current_offered`
  ADD PRIMARY KEY (`id_current_offered`);

--
-- Indices de la tabla `energia_transacciones`
--
ALTER TABLE `energia_transacciones`
  ADD PRIMARY KEY (`id_ener_trans`);

--
-- Indices de la tabla `energy_active_import_register`
--
ALTER TABLE `energy_active_import_register`
  ADD PRIMARY KEY (`id_ene_act_imp_reg`);
...
--
-- Indices de la tabla `ping_estacion`
--
ALTER TABLE `ping_estacion`
  ADD PRIMARY KEY (`id_ping_estacion`);

--
-- Indices de la tabla `potencia_transacciones`
--
ALTER TABLE `potencia_transacciones`
  ADD PRIMARY KEY (`id_pot_trans`);

--
-- Indices de la tabla `power_active_import`
--
ALTER TABLE `power_active_import`
  ADD PRIMARY KEY (`id_pow_act_imp`);
...
--
-- Indices de la tabla `state_of_charge`
--
ALTER TABLE `state_of_charge`
  ADD PRIMARY KEY (`id_state_of_charge`);
...
--
-- Indices de la tabla `voltage_phase1n`
--
ALTER TABLE `voltage_phase1n`
  ADD PRIMARY KEY (`id_voltage_phase1n`);

--
-- Indices de la tabla `voltage_phase2n`
--
ALTER TABLE `voltage_phase2n`
  ADD PRIMARY KEY (`id_voltage_phase2n`);

--
-- Indices de la tabla `voltage_phase3n`
--
ALTER TABLE `voltage_phase3n`
  ADD PRIMARY KEY (`id_voltage_phase3n`);
...
--
-- AUTO_INCREMENT de la tabla `current_import_phase1`
--
ALTER TABLE `current_import_phase1`
  MODIFY `id_current_import_phase1` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `current_import_phase2`
--
ALTER TABLE `current_import_phase2`
  MODIFY `id_current_import_phase2` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `current_import_phase3`
--
ALTER TABLE `current_import_phase3`
  MODIFY `id_current_import_phase3` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `current_offered`
--
ALTER TABLE `current_offered`
  MODIFY `id_current_offered` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `energia_transacciones`
--
ALTER TABLE `energia_transacciones`
  MODIFY `id_ener_trans` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `energy_active_import_register`
--
ALTER TABLE `energy_active_import_register`
  MODIFY `id_ene_act_imp_reg` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `ping_estacion`
--
ALTER TABLE `ping_estacion`
  MODIFY `id_ping_estacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `potencia_transacciones`
--
ALTER TABLE `potencia_transacciones`
  MODIFY `id_pot_trans` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `power_active_import`
--
ALTER TABLE `power_active_import`
  MODIFY `id_pow_act_imp` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `state_of_charge`
--
ALTER TABLE `state_of_charge`
  MODIFY `id_state_of_charge` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `transacciones`
  MODIFY `id_transaccion` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
-- AUTO_INCREMENT de la tabla `voltage_phase1n`
--
ALTER TABLE `voltage_phase1n`
  MODIFY `id_voltage_phase1n` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `voltage_phase2n`
--
ALTER TABLE `voltage_phase2n`
  MODIFY `id_voltage_phase2n` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `voltage_phase3n`
--
ALTER TABLE `voltage_phase3n`
  MODIFY `id_voltage_phase3n` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
